...
from .views import CustomerViewSet, CartViewSet, AddToCartViewSet, ViewCartViewSet, RemoveFromCartViewSet,ProductViewSet, customer_id_list, check_customer_details,create_product, check_product_details,get_products_by_user,save_summary,get_bills,get_customer_by_name,customer_detail,search_customers,create_product2
